    ...
    public class FileNameSampleServiceFixture : CoreTest<FileNameSampleService>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IBuildFileNames>()
                  .Setup(c => c.BuildFileName(It.IsAny<Movie>(), It.IsAny<MovieFile>(), _namingConfig)).Returns("Movie");
        ...
        {
            Mocker.GetMock<IBuildFileNames>()
                .Setup(c => c.BuildFileName(It.IsAny<Movie>(), It.IsAny<MovieFile>(), _namingConfig))
